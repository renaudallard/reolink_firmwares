# Reolink RLC-1224A Firmware Security & Connectivity Analysis
...
This is a **different key** from the Duo 3 PoE (fingerprint `C3:61:12:65:DD:E2:FF:12:AE:C1:49:4B:16:88:2A:A1:06:24:03:8E`), meaning each product line has its own shared key. Any attacker who downloads this firmware can extract the private key and perform man-in-the-middle attacks against HTTPS connections to any RLC-1224A running this firmware.
...
| TLS cert fingerprint | `0D:5D:11:...` | `C3:61:12:...` |
